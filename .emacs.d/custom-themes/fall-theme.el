...
(custom-theme-set-faces
 'fall
 '(default ((t (:background "gray95" :foreground "black")))) ;#bab9ba
 ...
 '(font-lock-function-name-face ((t (:foreground "black" t))))
 '(font-lock-keyword-face ((t (:foreground "dark red" t))))
