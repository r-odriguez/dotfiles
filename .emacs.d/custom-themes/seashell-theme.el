...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(font-lock-function-name-face ((,class (:foreground ,var :italic t))))
   ...
   `(trailing-whitespace ((,class :foreground ,fg6 :background ,bg1)))
   `(whitespace-space ((,class :foreground ,bg2 :background ,bg1)))
   `(whitespace-newline ((,class :foreground ,bg2 :background ,bg1)))
   `(whitespace-identation ((,class :foreground ,bg2 :background ,bg1)))
   `(whitespace-tab ((,class :foreground ,bg2 :background ,bg1)))
  ...
  (if (< emacs-major-version 22)
	...
	(custom-theme-set-faces
	 'seashell
	 `(show-paren-match ((,class (:foreground ,bg1 :background ,keyword))))
